export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Free models provided by MiMoCode",
  ...
  "provider.connect.apiKey.description":
    "Enter your {{provider}} API key to connect your account and use {{provider}} models in MiMoCode.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " to collect your authorization code to connect your account and use {{provider}} models in MiMoCode.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " and enter the code below to connect your account and use {{provider}} models in MiMoCode.",
  ...
  "dialog.server.description": "Switch which MiMoCode server this app connects to.",
  ...
  "toast.update.description": "A new version of MiMoCode ({{version}}) is now available to install.",
  ...
  "error.page.report.prefix": "Please report this error to the MiMoCode team",
  ...
  "error.chain.mcpFailed": 'MCP server "{{name}}" failed. Note, MiMoCode does not support MCP authentication yet.',
  ...
  "sidebar.gettingStarted.line1": "MiMoCode includes free models so you can start immediately.",
  ...
  "app.name.desktop": "MiMoCode Desktop",
  ...
  "settings.desktop.wsl.description": "Run the MiMoCode server inside WSL on Windows.",
  ...
  "settings.general.row.language.description": "Change the display language for MiMoCode",
  "settings.general.row.appearance.title": "Appearance",
  "settings.general.row.appearance.description": "Customise how MiMoCode looks on your device",
  "settings.general.row.colorScheme.title": "Color scheme",
  "settings.general.row.colorScheme.description": "Choose whether MiMoCode follows the system, light, or dark theme",
  "settings.general.row.theme.title": "Theme",
  "settings.general.row.theme.description": "Customise how MiMoCode is themed.",
  ...
  "settings.updates.row.startup.description": "Automatically check for updates when MiMoCode launches",
  ...
  "settings.updates.toast.latest.description": "You're running the latest version of MiMoCode.",
  ...
  "settings.skills.description": "{{enabled}} of {{total}} skills enabled. Disable a skill to prevent it from being available to agents.",
